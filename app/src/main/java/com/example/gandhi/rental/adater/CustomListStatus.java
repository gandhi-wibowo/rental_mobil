...
public class CustomListStatus extends BaseAdapter {
    ...
    public CustomListStatus(Activity activity, List<Mobil> mobilItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) convertView = inflater.inflate(R.layout.list_status, null);
        ...
        TextView idSewa = (TextView) convertView.findViewById(R.id.idSewa);

        // getting movie data for the row
        Mobil m = mobilItems.get(position);
        idSewa.setText(m.getIdSewa());
