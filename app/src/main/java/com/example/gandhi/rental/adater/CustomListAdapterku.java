...
public class CustomListAdapterku extends BaseAdapter {
	// nampilin daftar mobilku
	private Activity activity;
	private LayoutInflater inflater;
	private List<Mobil> mobilItems;
	ImageLoader imageLoader = AppController.getInstance().getImageLoader();

	public CustomListAdapterku(Activity activity, List<Mobil> mobilItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) convertView = inflater.inflate(R.layout.list_rowku, null);
