...
public class CustomListRental extends BaseAdapter {
	...
	public CustomListRental(Activity activity, List<Mobil> mobilItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) convertView = inflater.inflate(R.layout.list_rental, null);
