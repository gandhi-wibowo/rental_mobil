...
import com.example.gandhi.rental.adater.CustomListRental;
...
public class Rental extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    private CustomListRental adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new CustomListRental(this,mobilList);
    ...
    private void GetMobil(){
        String orderUrl = url + "/?id_pemesan=" + GetShared("Data_id","Key_id");
        JsonArrayRequest mobilReq = new JsonArrayRequest(orderUrl,
                new Response.Listener<JSONArray>() {
                    @Override
                    public void onResponse(JSONArray response) {
                        System.out.println("Sampai disini !");
                        hidePDialog();
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Intent intent = new Intent(getApplicationContext(),DetailRental.class);
        Bundle b = new Bundle();
